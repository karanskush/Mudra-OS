...
const Support: React.FC = () => (
  <section className="mb-8 p-6 bg-gradient-to-r from-blue-50 to-gray-50   rounded-2xl shadow border border-blue-200 ">
    <h2 className="text-2xl font-bold mb-2 flex items-center gap-2">
      <HelpCircle className="w-6 h-6 text-blue-600 " /> Support & Community
    </h2>
    <div className="mb-4">
      ...
      <ul className="space-y-2">
        {faqs.map((faq, i) => (
          <li key={i} className="border-l-4 border-blue-400 pl-4 py-2">
            <div className="font-medium text-gray-800 ">{faq.q}</div>
    ...
    <div className="flex gap-6 mt-4">
      <a href="mailto:support@mudracoreos.com" className="flex items-center gap-2 text-blue-700  hover:underline">
        <Mail className="w-4 h-4" />
        support@mudracoreos.com
      </a>
      <a href="https://github.com/your-org/mudracoreos" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-blue-700  hover:underline">
