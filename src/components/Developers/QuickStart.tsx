...
const QuickStart: React.FC = () => (
  <section className="mb-8 p-6 bg-gradient-to-r from-blue-100 to-blue-50 dark:from-blue-900 dark:to-slate-900 rounded-2xl shadow border border-blue-200 dark:border-blue-800">
    <h2 className="text-2xl font-bold mb-2 flex items-center gap-2">
      <KeyRound className="w-6 h-6 text-blue-600 dark:text-blue-300" /> Quick Start
    </h2>
    <ol className="list-decimal ml-6 text-gray-700 dark:text-gray-200 mb-4">
      <li>Sign up and log in to your developer account.</li>
      <li>Generate your API key from the dashboard.</li>
      <li>Authenticate requests by including your API key in the <span className="font-mono bg-gray-200 dark:bg-slate-800 px-1 rounded">Authorization</span> header.</li>
      <li>Explore endpoints below and use the interactive playground to test requests.</li>
    </ol>
    <div className="flex gap-4 mt-4 flex-wrap">
      <a href="/api-docs/swagger.json" download className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-semibold shadow transition-all">
