...
- **Proto Definitions**: Located in `backend/proto/` directory
- **Generated Code**: Available in `backend/proto/gen/proto/`
- **Handler Implementations**: Located in `backend/internal/grpc/handlers/`
